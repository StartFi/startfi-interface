...
const WaitingConfirmation: React.FunctionComponent<WaitingConfirmationProps> = ({
  isOpen,
  bidOrBuy,
  ownername,
  owner
  ...
  return (
    <React.Fragment>
      ...
      <Container>
        ...
        <Text>{t(`waitingConfirmation`, { bidorbuy, ownername, owner: shortenAddress(owner, 6) })}</Text>
